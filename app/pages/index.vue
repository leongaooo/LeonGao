...
<template>
    <CommonFlickeringGrid :square-size="35" :grid-gap="5" >
        <article class="max-w-[800px] w-full m-auto p-3 relative top-0 left-0">
            <h1>Leon Gao</h1>
            <p>
                <CommonTextEffect :perSpeed="10" words="Hello! I'm Leon Gao, my Chinese name is 高立民." />
                <CommonTextEffect :perSpeed="30"
            ...
            <template v-if="isShowDom">
                <p class="scroll-animation">
                    <CommonTextEffect :duration="5" :perSpeed="50" words="你好！我叫Leon Gao, 中文名叫高立民。" />
                    <CommonTextEffect :duration="6" :perSpeed="50"
                        words="目前我侧重于Web3D领域，同时对GIS地理开发感兴趣，业余时间会努力学英语，和全栈开发的学习。" />
                    <CommonTextEffect :duration="7" :perSpeed="50"
                ...
                <BriefAlink href="https://github.com/leongaooo" class="scroll-animation">
                    <template #icon>
                        <img style=" filter: drop-shadow(2px 4px 6px black);" src="/assets/icon/github.svg"
                            alt="GitHub">
                    </template>
                    leongaooo
                </BriefAlink>
                <BriefAlink href="https://juejin.cn/user/3976252950591149/columns" class="scroll-animation">
                    <template #icon>
                        <img src="/assets/icon/juejin.png" alt="JueJin">
                    </template>
                    JueJin
                </BriefAlink>
                <BriefAlink href="https://blog.csdn.net/g18204746769?spm=1000.2115.3001.5343" class="scroll-animation">
                    <template #icon>
                ...
                <p class="scroll-animation">
                    Render：
                    <BriefAlink href="https://developer.mozilla.org/en-US/docs/Web/API/Canvas_API">
                        <template #icon>
                    ...
                    <BriefAlink href="https://developer.mozilla.org/en-US/docs/Web/SVG/Reference/Attribute">
                        <template #icon>
                ...
                <p class="scroll-animation">
                    ...
                    <BriefAlink href="https://developer.mozilla.org/en-US/docs/Web/API/CSS">
                        <template #icon>
                ...
                <br />
                <span class="text-sm op50 scroll-animation"
